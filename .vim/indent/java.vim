...
let b:did_indent = 1
"noremap <silent> i :call GoInsertI()<CR>
"noremap <silent> a :call GoInsertA()<CR>
setlocal indentkeys+=!0<Tab>,;,*<Return>
...
setlocal indentkeys+=0=extends indentkeys+=0=implements
